...
```javascript
iterHacovercos = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-hacovercos@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-iter-special-hacovercos/tags). For example,

```javascript
iterHacovercos = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-hacovercos@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var iterHacovercos = require( 'path/to/vendor/umd/math-iter-special-hacovercos/index.js' )
```
...
[test-image]: https://github.com/stdlib-js/math-iter-special-hacovercos/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/math-iter-special-hacovercos/actions/workflows/test.yml?query=branch:v0.1.0

...
```javascript
iterHacovercos = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-hacovercos@v0.2.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/math-iter-special-hacovercos/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/math-iter-special-hacovercos/actions/workflows/test.yml?query=branch:v0.2.2
